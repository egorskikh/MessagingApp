...
private final class NavigationController: UINavigationController {
  ...
  init(tabBarTitle: TabBarTitle) {
    ...
    case .contacts:
      ...
      let viewController = contactsStoryboard
        .instantiateViewController(withIdentifier: "ContactListTableViewController")
      rootViewController = viewController
      
      case .profile: rootViewController = ProfileViewController()
    }
